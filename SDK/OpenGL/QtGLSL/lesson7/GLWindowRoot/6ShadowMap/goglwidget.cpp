...
GOGLWidget* GOGLWidget::_main_window = nullptr;

int GOGLWidget::GetWindowWidth()
{
    if(_main_window)
        return _main_window->window_width_;
    return 0;
}

int GOGLWidget::GetWindowHeight()
{
    if(_main_window)
        return _main_window->window_height_;
    return 0;
}
...
void GOGLWidget::InitCubeForLight(GCubeForShadow& cube, int index, GLightBase& light)
{
    GUniformType uniform_types[] = {
        GUniformType::kTranslate,
        GUniformType::kViewMatrix,
